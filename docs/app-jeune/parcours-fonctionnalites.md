...
4. Plan d'action        → construit par l'app, personnalisé d'après le questionnaire
...
| Page | Contenu |
|---|---|
| **Accueil** | Plan d'action personnalisé avec cases à cocher ; les actions peuvent rediriger vers des liens externes ou des deeplinks |
...
| Nouveau public non FT (lycéens, collégiens, étudiants, NEET, tout venant) | **Mode invité** (« sans compte ») | Tout **sauf agenda, création d'actions, compteur d'heures, chat** | Mode invité à définir (voir [`utilisateurs-authentification.md`](./utilisateurs-authentification.md)) |
